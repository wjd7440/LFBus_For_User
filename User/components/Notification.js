...
export default class Notification extends React.Component {
  render() {
    ...
    const iconContainer = [
      ...
      { backgroundColor: color || wezonTheme.COLORS.PRIMARY },
    ...
    const container = [
      styles.card,
      !transparent && { backgroundColor: wezonTheme.COLORS.WHITE },
        ...
        <TouchableWithoutFeedback onPress={onPress}>
          <Block row style={{ width: "95%" }}>
            <Block top flex={system ? 0.12 : 0.2} middle>
              <Block middle style={iconContainer}></Block>
            </Block>
            <Block flex style={{ paddingRight: 3, paddingLeft: 12 }}>
              <Text
                color={wezonTheme.COLORS.TEXT}
                size={system ? 13 : 14}
                style={{
